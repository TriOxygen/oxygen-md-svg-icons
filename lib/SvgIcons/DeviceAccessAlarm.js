...
var DeviceAccessAlarm = function (_Component) {
  _inherits(DeviceAccessAlarm, _Component);

  function DeviceAccessAlarm() {
    _classCallCheck(this, DeviceAccessAlarm);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceAccessAlarm).apply(this, arguments));
  }

  _createClass(DeviceAccessAlarm, [{
    key: 'render',
