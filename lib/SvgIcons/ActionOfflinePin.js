...
var ActionOfflinePin = function (_Component) {
  _inherits(ActionOfflinePin, _Component);

  function ActionOfflinePin() {
    _classCallCheck(this, ActionOfflinePin);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionOfflinePin).apply(this, arguments));
  }

  _createClass(ActionOfflinePin, [{
    key: 'render',
