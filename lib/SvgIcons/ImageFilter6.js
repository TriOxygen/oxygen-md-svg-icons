...
var ImageFilter6 = function (_Component) {
  _inherits(ImageFilter6, _Component);

  function ImageFilter6() {
    _classCallCheck(this, ImageFilter6);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageFilter6).apply(this, arguments));
  }

  _createClass(ImageFilter6, [{
    key: 'render',
