...
var MapsLocalAtm = function (_Component) {
  _inherits(MapsLocalAtm, _Component);

  function MapsLocalAtm() {
    _classCallCheck(this, MapsLocalAtm);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalAtm).apply(this, arguments));
  }

  _createClass(MapsLocalAtm, [{
    key: 'render',
