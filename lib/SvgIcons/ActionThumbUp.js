...
var ActionThumbUp = function (_Component) {
  _inherits(ActionThumbUp, _Component);

  function ActionThumbUp() {
    _classCallCheck(this, ActionThumbUp);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionThumbUp).apply(this, arguments));
  }

  _createClass(ActionThumbUp, [{
    key: 'render',
