...
var ImageLeakAdd = function (_Component) {
  _inherits(ImageLeakAdd, _Component);

  function ImageLeakAdd() {
    _classCallCheck(this, ImageLeakAdd);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageLeakAdd).apply(this, arguments));
  }

  _createClass(ImageLeakAdd, [{
    key: 'render',
