...
var AvAlbum = function (_Component) {
  _inherits(AvAlbum, _Component);

  function AvAlbum() {
    _classCallCheck(this, AvAlbum);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvAlbum).apply(this, arguments));
  }

  _createClass(AvAlbum, [{
    key: 'render',
