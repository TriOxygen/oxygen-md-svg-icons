...
var ToggleStarBorder = function (_Component) {
  _inherits(ToggleStarBorder, _Component);

  function ToggleStarBorder() {
    _classCallCheck(this, ToggleStarBorder);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ToggleStarBorder).apply(this, arguments));
  }

  _createClass(ToggleStarBorder, [{
    key: 'render',
