...
var ImageCrop = function (_Component) {
  _inherits(ImageCrop, _Component);

  function ImageCrop() {
    _classCallCheck(this, ImageCrop);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageCrop).apply(this, arguments));
  }
