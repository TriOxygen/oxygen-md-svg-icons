...
var AvVolumeUp = function (_Component) {
  _inherits(AvVolumeUp, _Component);

  function AvVolumeUp() {
    _classCallCheck(this, AvVolumeUp);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvVolumeUp).apply(this, arguments));
  }

  _createClass(AvVolumeUp, [{
    key: 'render',
