...
var ActionAccountCircle = function (_Component) {
  _inherits(ActionAccountCircle, _Component);

  function ActionAccountCircle() {
    _classCallCheck(this, ActionAccountCircle);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionAccountCircle).apply(this, arguments));
  }

  _createClass(ActionAccountCircle, [{
    key: 'render',
