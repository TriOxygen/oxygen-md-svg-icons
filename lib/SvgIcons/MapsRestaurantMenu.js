...
var MapsRestaurantMenu = function (_Component) {
  _inherits(MapsRestaurantMenu, _Component);

  function MapsRestaurantMenu() {
    _classCallCheck(this, MapsRestaurantMenu);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsRestaurantMenu).apply(this, arguments));
  }

  _createClass(MapsRestaurantMenu, [{
    key: 'render',
