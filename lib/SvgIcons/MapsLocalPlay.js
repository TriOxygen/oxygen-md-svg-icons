...
var MapsLocalPlay = function (_Component) {
  _inherits(MapsLocalPlay, _Component);

  function MapsLocalPlay() {
    _classCallCheck(this, MapsLocalPlay);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalPlay).apply(this, arguments));
  }

  _createClass(MapsLocalPlay, [{
    key: 'render',
