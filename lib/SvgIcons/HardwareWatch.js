...
var HardwareWatch = function (_Component) {
  _inherits(HardwareWatch, _Component);

  function HardwareWatch() {
    _classCallCheck(this, HardwareWatch);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(HardwareWatch).apply(this, arguments));
  }

  _createClass(HardwareWatch, [{
    key: 'render',
