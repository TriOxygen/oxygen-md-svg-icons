...
var EditorFormatBold = function (_Component) {
  _inherits(EditorFormatBold, _Component);

  function EditorFormatBold() {
    _classCallCheck(this, EditorFormatBold);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorFormatBold).apply(this, arguments));
  }

  _createClass(EditorFormatBold, [{
    key: 'render',
