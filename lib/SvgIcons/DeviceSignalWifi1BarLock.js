...
var DeviceSignalWifi1BarLock = function (_Component) {
  _inherits(DeviceSignalWifi1BarLock, _Component);

  function DeviceSignalWifi1BarLock() {
    _classCallCheck(this, DeviceSignalWifi1BarLock);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceSignalWifi1BarLock).apply(this, arguments));
  }

  _createClass(DeviceSignalWifi1BarLock, [{
    key: 'render',
  ...
  return DeviceSignalWifi1BarLock;
}(_react.Component);
