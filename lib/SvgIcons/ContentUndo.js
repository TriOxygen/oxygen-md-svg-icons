...
var ContentUndo = function (_Component) {
  _inherits(ContentUndo, _Component);

  function ContentUndo() {
    _classCallCheck(this, ContentUndo);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentUndo).apply(this, arguments));
  }

  _createClass(ContentUndo, [{
    key: 'render',
