...
var ImageFilter8 = function (_Component) {
  _inherits(ImageFilter8, _Component);

  function ImageFilter8() {
    _classCallCheck(this, ImageFilter8);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageFilter8).apply(this, arguments));
  }

  _createClass(ImageFilter8, [{
    key: 'render',
