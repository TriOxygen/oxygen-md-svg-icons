...
var SocialDomain = function (_Component) {
  _inherits(SocialDomain, _Component);

  function SocialDomain() {
    _classCallCheck(this, SocialDomain);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialDomain).apply(this, arguments));
  }

  _createClass(SocialDomain, [{
    key: 'render',
