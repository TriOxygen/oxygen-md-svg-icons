...
var ActionThumbDown = function (_Component) {
  _inherits(ActionThumbDown, _Component);

  function ActionThumbDown() {
    _classCallCheck(this, ActionThumbDown);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionThumbDown).apply(this, arguments));
  }

  _createClass(ActionThumbDown, [{
    key: 'render',
