...
var EditorAttachFile = function (_Component) {
  _inherits(EditorAttachFile, _Component);

  function EditorAttachFile() {
    _classCallCheck(this, EditorAttachFile);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorAttachFile).apply(this, arguments));
  }

  _createClass(EditorAttachFile, [{
    key: 'render',
