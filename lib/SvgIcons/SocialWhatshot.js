...
var SocialWhatshot = function (_Component) {
  _inherits(SocialWhatshot, _Component);

  function SocialWhatshot() {
    _classCallCheck(this, SocialWhatshot);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialWhatshot).apply(this, arguments));
  }

  _createClass(SocialWhatshot, [{
    key: 'render',
