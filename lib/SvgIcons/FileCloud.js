...
var FileCloud = function (_Component) {
  _inherits(FileCloud, _Component);

  function FileCloud() {
    _classCallCheck(this, FileCloud);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FileCloud).apply(this, arguments));
  }

  _createClass(FileCloud, [{
    key: 'render',
