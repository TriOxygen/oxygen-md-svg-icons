...
var ImageLooks = function (_Component) {
  _inherits(ImageLooks, _Component);

  function ImageLooks() {
    _classCallCheck(this, ImageLooks);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageLooks).apply(this, arguments));
  }

  _createClass(ImageLooks, [{
    key: 'render',
