...
var SocialPages = function (_Component) {
  _inherits(SocialPages, _Component);

  function SocialPages() {
    _classCallCheck(this, SocialPages);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialPages).apply(this, arguments));
  }

  _createClass(SocialPages, [{
    key: 'render',
