...
var ActionShoppingBasket = function (_Component) {
  _inherits(ActionShoppingBasket, _Component);

  function ActionShoppingBasket() {
    _classCallCheck(this, ActionShoppingBasket);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionShoppingBasket).apply(this, arguments));
  }

  _createClass(ActionShoppingBasket, [{
    key: 'render',
