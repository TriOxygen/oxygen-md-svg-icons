...
var SocialPersonOutline = function (_Component) {
  _inherits(SocialPersonOutline, _Component);

  function SocialPersonOutline() {
    _classCallCheck(this, SocialPersonOutline);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialPersonOutline).apply(this, arguments));
  }

  _createClass(SocialPersonOutline, [{
    key: 'render',
