...
var MapsPlace = function (_Component) {
  _inherits(MapsPlace, _Component);

  function MapsPlace() {
    _classCallCheck(this, MapsPlace);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsPlace).apply(this, arguments));
  }

  _createClass(MapsPlace, [{
    key: 'render',
