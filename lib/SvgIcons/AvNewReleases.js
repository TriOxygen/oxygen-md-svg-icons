...
var AvNewReleases = function (_Component) {
  _inherits(AvNewReleases, _Component);

  function AvNewReleases() {
    _classCallCheck(this, AvNewReleases);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvNewReleases).apply(this, arguments));
  }

  _createClass(AvNewReleases, [{
    key: 'render',
