...
var AvForward10 = function (_Component) {
  _inherits(AvForward10, _Component);

  function AvForward10() {
    _classCallCheck(this, AvForward10);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvForward10).apply(this, arguments));
  }

  _createClass(AvForward10, [{
    key: 'render',
