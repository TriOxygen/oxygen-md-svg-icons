...
var ActionBackup = function (_Component) {
  _inherits(ActionBackup, _Component);

  function ActionBackup() {
    _classCallCheck(this, ActionBackup);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionBackup).apply(this, arguments));
  }

  _createClass(ActionBackup, [{
    key: 'render',
