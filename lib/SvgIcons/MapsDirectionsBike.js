...
var MapsDirectionsBike = function (_Component) {
  _inherits(MapsDirectionsBike, _Component);

  function MapsDirectionsBike() {
    _classCallCheck(this, MapsDirectionsBike);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsDirectionsBike).apply(this, arguments));
  }

  _createClass(MapsDirectionsBike, [{
    key: 'render',
