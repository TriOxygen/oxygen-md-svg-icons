...
var ContentArchive = function (_Component) {
  _inherits(ContentArchive, _Component);

  function ContentArchive() {
    _classCallCheck(this, ContentArchive);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentArchive).apply(this, arguments));
  }

  _createClass(ContentArchive, [{
    key: 'render',
