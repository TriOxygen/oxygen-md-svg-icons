...
var ContentDrafts = function (_Component) {
  _inherits(ContentDrafts, _Component);

  function ContentDrafts() {
    _classCallCheck(this, ContentDrafts);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentDrafts).apply(this, arguments));
  }

  _createClass(ContentDrafts, [{
    key: 'render',
