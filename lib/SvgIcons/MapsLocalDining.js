...
var MapsLocalDining = function (_Component) {
  _inherits(MapsLocalDining, _Component);

  function MapsLocalDining() {
    _classCallCheck(this, MapsLocalDining);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalDining).apply(this, arguments));
  }

  _createClass(MapsLocalDining, [{
    key: 'render',
