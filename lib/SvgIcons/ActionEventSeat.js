...
var ActionEventSeat = function (_Component) {
  _inherits(ActionEventSeat, _Component);

  function ActionEventSeat() {
    _classCallCheck(this, ActionEventSeat);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionEventSeat).apply(this, arguments));
  }

  _createClass(ActionEventSeat, [{
    key: 'render',
