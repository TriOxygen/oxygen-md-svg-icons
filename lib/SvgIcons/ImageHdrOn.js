...
var ImageHdrOn = function (_Component) {
  _inherits(ImageHdrOn, _Component);

  function ImageHdrOn() {
    _classCallCheck(this, ImageHdrOn);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageHdrOn).apply(this, arguments));
  }

  _createClass(ImageHdrOn, [{
    key: 'render',
