...
var ContentBackspace = function (_Component) {
  _inherits(ContentBackspace, _Component);

  function ContentBackspace() {
    _classCallCheck(this, ContentBackspace);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentBackspace).apply(this, arguments));
  }

  _createClass(ContentBackspace, [{
    key: 'render',
