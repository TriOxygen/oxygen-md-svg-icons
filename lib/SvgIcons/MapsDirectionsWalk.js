...
var MapsDirectionsWalk = function (_Component) {
  _inherits(MapsDirectionsWalk, _Component);

  function MapsDirectionsWalk() {
    _classCallCheck(this, MapsDirectionsWalk);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsDirectionsWalk).apply(this, arguments));
  }

  _createClass(MapsDirectionsWalk, [{
    key: 'render',
