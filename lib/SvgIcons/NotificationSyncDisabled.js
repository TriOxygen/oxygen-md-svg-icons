...
var NotificationSyncDisabled = function (_Component) {
  _inherits(NotificationSyncDisabled, _Component);

  function NotificationSyncDisabled() {
    _classCallCheck(this, NotificationSyncDisabled);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NotificationSyncDisabled).apply(this, arguments));
  }

  _createClass(NotificationSyncDisabled, [{
    key: 'render',
