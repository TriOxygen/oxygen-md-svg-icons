...
var FileFolderShared = function (_Component) {
  _inherits(FileFolderShared, _Component);

  function FileFolderShared() {
    _classCallCheck(this, FileFolderShared);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FileFolderShared).apply(this, arguments));
  }

  _createClass(FileFolderShared, [{
    key: 'render',
