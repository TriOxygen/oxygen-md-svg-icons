...
var ActionSettingsPower = function (_Component) {
  _inherits(ActionSettingsPower, _Component);

  function ActionSettingsPower() {
    _classCallCheck(this, ActionSettingsPower);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionSettingsPower).apply(this, arguments));
  }

  _createClass(ActionSettingsPower, [{
    key: 'render',
