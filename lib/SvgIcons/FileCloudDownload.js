...
var FileCloudDownload = function (_Component) {
  _inherits(FileCloudDownload, _Component);

  function FileCloudDownload() {
    _classCallCheck(this, FileCloudDownload);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FileCloudDownload).apply(this, arguments));
  }

  _createClass(FileCloudDownload, [{
    key: 'render',
