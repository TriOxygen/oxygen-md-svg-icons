...
var ActionReceipt = function (_Component) {
  _inherits(ActionReceipt, _Component);

  function ActionReceipt() {
    _classCallCheck(this, ActionReceipt);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionReceipt).apply(this, arguments));
  }

  _createClass(ActionReceipt, [{
    key: 'render',
