...
var HardwareSpeakerGroup = function (_Component) {
  _inherits(HardwareSpeakerGroup, _Component);

  function HardwareSpeakerGroup() {
    _classCallCheck(this, HardwareSpeakerGroup);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(HardwareSpeakerGroup).apply(this, arguments));
  }

  _createClass(HardwareSpeakerGroup, [{
    key: 'render',
