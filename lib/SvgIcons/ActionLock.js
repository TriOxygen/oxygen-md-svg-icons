...
var ActionLock = function (_Component) {
  _inherits(ActionLock, _Component);

  function ActionLock() {
    _classCallCheck(this, ActionLock);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionLock).apply(this, arguments));
  }

  _createClass(ActionLock, [{
    key: 'render',
