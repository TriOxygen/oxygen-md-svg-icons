...
var AvWeb = function (_Component) {
  _inherits(AvWeb, _Component);

  function AvWeb() {
    _classCallCheck(this, AvWeb);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvWeb).apply(this, arguments));
  }
