...
var EditorBorderColor = function (_Component) {
  _inherits(EditorBorderColor, _Component);

  function EditorBorderColor() {
    _classCallCheck(this, EditorBorderColor);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorBorderColor).apply(this, arguments));
  }

  _createClass(EditorBorderColor, [{
    key: 'render',
