...
var DeviceNetworkWifi = function (_Component) {
  _inherits(DeviceNetworkWifi, _Component);

  function DeviceNetworkWifi() {
    _classCallCheck(this, DeviceNetworkWifi);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceNetworkWifi).apply(this, arguments));
  }

  _createClass(DeviceNetworkWifi, [{
    key: 'render',
