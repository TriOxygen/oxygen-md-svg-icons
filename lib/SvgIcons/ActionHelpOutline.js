...
var ActionHelpOutline = function (_Component) {
  _inherits(ActionHelpOutline, _Component);

  function ActionHelpOutline() {
    _classCallCheck(this, ActionHelpOutline);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionHelpOutline).apply(this, arguments));
  }

  _createClass(ActionHelpOutline, [{
    key: 'render',
