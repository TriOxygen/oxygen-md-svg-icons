...
var MapsDirections = function (_Component) {
  _inherits(MapsDirections, _Component);

  function MapsDirections() {
    _classCallCheck(this, MapsDirections);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsDirections).apply(this, arguments));
  }

  _createClass(MapsDirections, [{
    key: 'render',
