...
var FileFolder = function (_Component) {
  _inherits(FileFolder, _Component);

  function FileFolder() {
    _classCallCheck(this, FileFolder);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FileFolder).apply(this, arguments));
  }

  _createClass(FileFolder, [{
    key: 'render',
