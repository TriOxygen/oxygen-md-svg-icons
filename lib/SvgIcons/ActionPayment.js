...
var ActionPayment = function (_Component) {
  _inherits(ActionPayment, _Component);

  function ActionPayment() {
    _classCallCheck(this, ActionPayment);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionPayment).apply(this, arguments));
  }

  _createClass(ActionPayment, [{
    key: 'render',
