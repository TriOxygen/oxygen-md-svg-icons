...
var AvShuffle = function (_Component) {
  _inherits(AvShuffle, _Component);

  function AvShuffle() {
    _classCallCheck(this, AvShuffle);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvShuffle).apply(this, arguments));
  }

  _createClass(AvShuffle, [{
    key: 'render',
