...
var ActionAutorenew = function (_Component) {
  _inherits(ActionAutorenew, _Component);

  function ActionAutorenew() {
    _classCallCheck(this, ActionAutorenew);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionAutorenew).apply(this, arguments));
  }

  _createClass(ActionAutorenew, [{
    key: 'render',
