...
var DeviceNfc = function (_Component) {
  _inherits(DeviceNfc, _Component);

  function DeviceNfc() {
    _classCallCheck(this, DeviceNfc);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceNfc).apply(this, arguments));
  }

  _createClass(DeviceNfc, [{
    key: 'render',
