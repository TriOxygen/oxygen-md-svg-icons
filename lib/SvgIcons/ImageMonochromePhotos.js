...
var ImageMonochromePhotos = function (_Component) {
  _inherits(ImageMonochromePhotos, _Component);

  function ImageMonochromePhotos() {
    _classCallCheck(this, ImageMonochromePhotos);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageMonochromePhotos).apply(this, arguments));
  }

  _createClass(ImageMonochromePhotos, [{
    key: 'render',
