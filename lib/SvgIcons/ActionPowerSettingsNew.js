...
var ActionPowerSettingsNew = function (_Component) {
  _inherits(ActionPowerSettingsNew, _Component);

  function ActionPowerSettingsNew() {
    _classCallCheck(this, ActionPowerSettingsNew);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionPowerSettingsNew).apply(this, arguments));
  }

  _createClass(ActionPowerSettingsNew, [{
    key: 'render',
