...
var ActionHighlightOff = function (_Component) {
  _inherits(ActionHighlightOff, _Component);

  function ActionHighlightOff() {
    _classCallCheck(this, ActionHighlightOff);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionHighlightOff).apply(this, arguments));
  }

  _createClass(ActionHighlightOff, [{
    key: 'render',
