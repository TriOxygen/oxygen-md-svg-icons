...
var EditorInsertLink = function (_Component) {
  _inherits(EditorInsertLink, _Component);

  function EditorInsertLink() {
    _classCallCheck(this, EditorInsertLink);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorInsertLink).apply(this, arguments));
  }

  _createClass(EditorInsertLink, [{
    key: 'render',
