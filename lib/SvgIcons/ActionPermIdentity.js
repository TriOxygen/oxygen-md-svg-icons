...
var ActionPermIdentity = function (_Component) {
  _inherits(ActionPermIdentity, _Component);

  function ActionPermIdentity() {
    _classCallCheck(this, ActionPermIdentity);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionPermIdentity).apply(this, arguments));
  }

  _createClass(ActionPermIdentity, [{
    key: 'render',
