...
var ContentReport = function (_Component) {
  _inherits(ContentReport, _Component);

  function ContentReport() {
    _classCallCheck(this, ContentReport);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentReport).apply(this, arguments));
  }

  _createClass(ContentReport, [{
    key: 'render',
