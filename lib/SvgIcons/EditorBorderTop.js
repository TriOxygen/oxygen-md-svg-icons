...
var EditorBorderTop = function (_Component) {
  _inherits(EditorBorderTop, _Component);

  function EditorBorderTop() {
    _classCallCheck(this, EditorBorderTop);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorBorderTop).apply(this, arguments));
  }

  _createClass(EditorBorderTop, [{
    key: 'render',
