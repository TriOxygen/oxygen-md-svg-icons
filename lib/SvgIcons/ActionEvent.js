...
var ActionEvent = function (_Component) {
  _inherits(ActionEvent, _Component);

  function ActionEvent() {
    _classCallCheck(this, ActionEvent);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionEvent).apply(this, arguments));
  }

  _createClass(ActionEvent, [{
    key: 'render',
