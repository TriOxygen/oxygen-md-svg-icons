...
var MapsLocalCarWash = function (_Component) {
  _inherits(MapsLocalCarWash, _Component);

  function MapsLocalCarWash() {
    _classCallCheck(this, MapsLocalCarWash);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalCarWash).apply(this, arguments));
  }

  _createClass(MapsLocalCarWash, [{
    key: 'render',
