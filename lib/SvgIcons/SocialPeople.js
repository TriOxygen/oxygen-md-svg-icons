...
var SocialPeople = function (_Component) {
  _inherits(SocialPeople, _Component);

  function SocialPeople() {
    _classCallCheck(this, SocialPeople);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialPeople).apply(this, arguments));
  }

  _createClass(SocialPeople, [{
    key: 'render',
