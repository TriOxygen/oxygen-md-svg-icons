...
var MapsLocalPhone = function (_Component) {
  _inherits(MapsLocalPhone, _Component);

  function MapsLocalPhone() {
    _classCallCheck(this, MapsLocalPhone);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalPhone).apply(this, arguments));
  }

  _createClass(MapsLocalPhone, [{
    key: 'render',
