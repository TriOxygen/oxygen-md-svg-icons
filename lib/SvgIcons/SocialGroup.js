...
var SocialGroup = function (_Component) {
  _inherits(SocialGroup, _Component);

  function SocialGroup() {
    _classCallCheck(this, SocialGroup);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialGroup).apply(this, arguments));
  }
