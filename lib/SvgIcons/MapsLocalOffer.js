...
var MapsLocalOffer = function (_Component) {
  _inherits(MapsLocalOffer, _Component);

  function MapsLocalOffer() {
    _classCallCheck(this, MapsLocalOffer);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalOffer).apply(this, arguments));
  }

  _createClass(MapsLocalOffer, [{
    key: 'render',
