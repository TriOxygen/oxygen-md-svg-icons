...
var EditorFormatListBulleted = function (_Component) {
  _inherits(EditorFormatListBulleted, _Component);

  function EditorFormatListBulleted() {
    _classCallCheck(this, EditorFormatListBulleted);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorFormatListBulleted).apply(this, arguments));
  }

  _createClass(EditorFormatListBulleted, [{
    key: 'render',
  ...
  return EditorFormatListBulleted;
}(_react.Component);
