...
var ActionDns = function (_Component) {
  _inherits(ActionDns, _Component);

  function ActionDns() {
    _classCallCheck(this, ActionDns);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionDns).apply(this, arguments));
  }

  _createClass(ActionDns, [{
    key: 'render',
