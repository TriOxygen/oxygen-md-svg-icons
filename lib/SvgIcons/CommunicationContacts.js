...
var CommunicationContacts = function (_Component) {
  _inherits(CommunicationContacts, _Component);

  function CommunicationContacts() {
    _classCallCheck(this, CommunicationContacts);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationContacts).apply(this, arguments));
  }

  _createClass(CommunicationContacts, [{
    key: 'render',
