...
var ActionInfo = function (_Component) {
  _inherits(ActionInfo, _Component);

  function ActionInfo() {
    _classCallCheck(this, ActionInfo);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionInfo).apply(this, arguments));
  }
