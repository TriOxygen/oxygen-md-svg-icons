...
var SocialMoodBad = function (_Component) {
  _inherits(SocialMoodBad, _Component);

  function SocialMoodBad() {
    _classCallCheck(this, SocialMoodBad);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialMoodBad).apply(this, arguments));
  }

  _createClass(SocialMoodBad, [{
    key: 'render',
