...
var ImageCamera = function (_Component) {
  _inherits(ImageCamera, _Component);

  function ImageCamera() {
    _classCallCheck(this, ImageCamera);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageCamera).apply(this, arguments));
  }

  _createClass(ImageCamera, [{
    key: 'render',
