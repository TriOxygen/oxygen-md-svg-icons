...
var ActionRestore = function (_Component) {
  _inherits(ActionRestore, _Component);

  function ActionRestore() {
    _classCallCheck(this, ActionRestore);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionRestore).apply(this, arguments));
  }

  _createClass(ActionRestore, [{
    key: 'render',
