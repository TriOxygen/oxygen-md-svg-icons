...
var MapsLayersClear = function (_Component) {
  _inherits(MapsLayersClear, _Component);

  function MapsLayersClear() {
    _classCallCheck(this, MapsLayersClear);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLayersClear).apply(this, arguments));
  }

  _createClass(MapsLayersClear, [{
    key: 'render',
