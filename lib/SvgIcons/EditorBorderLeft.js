...
var EditorBorderLeft = function (_Component) {
  _inherits(EditorBorderLeft, _Component);

  function EditorBorderLeft() {
    _classCallCheck(this, EditorBorderLeft);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorBorderLeft).apply(this, arguments));
  }

  _createClass(EditorBorderLeft, [{
    key: 'render',
