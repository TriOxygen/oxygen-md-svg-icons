...
var ContentRedo = function (_Component) {
  _inherits(ContentRedo, _Component);

  function ContentRedo() {
    _classCallCheck(this, ContentRedo);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentRedo).apply(this, arguments));
  }

  _createClass(ContentRedo, [{
    key: 'render',
