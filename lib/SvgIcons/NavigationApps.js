...
var NavigationApps = function (_Component) {
  _inherits(NavigationApps, _Component);

  function NavigationApps() {
    _classCallCheck(this, NavigationApps);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavigationApps).apply(this, arguments));
  }

  _createClass(NavigationApps, [{
    key: 'render',
