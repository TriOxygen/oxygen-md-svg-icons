...
var CommunicationDialpad = function (_Component) {
  _inherits(CommunicationDialpad, _Component);

  function CommunicationDialpad() {
    _classCallCheck(this, CommunicationDialpad);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationDialpad).apply(this, arguments));
  }

  _createClass(CommunicationDialpad, [{
    key: 'render',
