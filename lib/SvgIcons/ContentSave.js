...
var ContentSave = function (_Component) {
  _inherits(ContentSave, _Component);

  function ContentSave() {
    _classCallCheck(this, ContentSave);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContentSave).apply(this, arguments));
  }

  _createClass(ContentSave, [{
    key: 'render',
