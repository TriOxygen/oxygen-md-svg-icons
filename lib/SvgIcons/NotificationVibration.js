...
var NotificationVibration = function (_Component) {
  _inherits(NotificationVibration, _Component);

  function NotificationVibration() {
    _classCallCheck(this, NotificationVibration);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NotificationVibration).apply(this, arguments));
  }

  _createClass(NotificationVibration, [{
    key: 'render',
