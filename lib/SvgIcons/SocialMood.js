...
var SocialMood = function (_Component) {
  _inherits(SocialMood, _Component);

  function SocialMood() {
    _classCallCheck(this, SocialMood);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialMood).apply(this, arguments));
  }

  _createClass(SocialMood, [{
    key: 'render',
