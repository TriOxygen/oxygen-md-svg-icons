...
var ImageStyle = function (_Component) {
  _inherits(ImageStyle, _Component);

  function ImageStyle() {
    _classCallCheck(this, ImageStyle);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageStyle).apply(this, arguments));
  }
