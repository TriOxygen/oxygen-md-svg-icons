...
var ActionSearch = function (_Component) {
  _inherits(ActionSearch, _Component);

  function ActionSearch() {
    _classCallCheck(this, ActionSearch);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionSearch).apply(this, arguments));
  }

  _createClass(ActionSearch, [{
    key: 'render',
