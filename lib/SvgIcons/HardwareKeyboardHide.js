...
var HardwareKeyboardHide = function (_Component) {
  _inherits(HardwareKeyboardHide, _Component);

  function HardwareKeyboardHide() {
    _classCallCheck(this, HardwareKeyboardHide);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(HardwareKeyboardHide).apply(this, arguments));
  }

  _createClass(HardwareKeyboardHide, [{
    key: 'render',
