...
var ActionAssignment = function (_Component) {
  _inherits(ActionAssignment, _Component);

  function ActionAssignment() {
    _classCallCheck(this, ActionAssignment);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionAssignment).apply(this, arguments));
  }

  _createClass(ActionAssignment, [{
    key: 'render',
