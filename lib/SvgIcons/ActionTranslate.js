...
var ActionTranslate = function (_Component) {
  _inherits(ActionTranslate, _Component);

  function ActionTranslate() {
    _classCallCheck(this, ActionTranslate);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionTranslate).apply(this, arguments));
  }

  _createClass(ActionTranslate, [{
    key: 'render',
