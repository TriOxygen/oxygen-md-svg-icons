...
var MapsLocalMall = function (_Component) {
  _inherits(MapsLocalMall, _Component);

  function MapsLocalMall() {
    _classCallCheck(this, MapsLocalMall);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalMall).apply(this, arguments));
  }

  _createClass(MapsLocalMall, [{
    key: 'render',
