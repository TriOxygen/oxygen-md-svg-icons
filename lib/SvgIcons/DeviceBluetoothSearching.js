...
var DeviceBluetoothSearching = function (_Component) {
  _inherits(DeviceBluetoothSearching, _Component);

  function DeviceBluetoothSearching() {
    _classCallCheck(this, DeviceBluetoothSearching);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DeviceBluetoothSearching).apply(this, arguments));
  }

  _createClass(DeviceBluetoothSearching, [{
    key: 'render',
  ...
  return DeviceBluetoothSearching;
}(_react.Component);
