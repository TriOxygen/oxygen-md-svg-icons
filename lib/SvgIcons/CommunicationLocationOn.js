...
var CommunicationLocationOn = function (_Component) {
  _inherits(CommunicationLocationOn, _Component);

  function CommunicationLocationOn() {
    _classCallCheck(this, CommunicationLocationOn);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationLocationOn).apply(this, arguments));
  }

  _createClass(CommunicationLocationOn, [{
    key: 'render',
