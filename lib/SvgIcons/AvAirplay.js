...
var AvAirplay = function (_Component) {
  _inherits(AvAirplay, _Component);

  function AvAirplay() {
    _classCallCheck(this, AvAirplay);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvAirplay).apply(this, arguments));
  }

  _createClass(AvAirplay, [{
    key: 'render',
