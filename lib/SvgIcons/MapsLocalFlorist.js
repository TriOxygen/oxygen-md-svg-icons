...
var MapsLocalFlorist = function (_Component) {
  _inherits(MapsLocalFlorist, _Component);

  function MapsLocalFlorist() {
    _classCallCheck(this, MapsLocalFlorist);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalFlorist).apply(this, arguments));
  }

  _createClass(MapsLocalFlorist, [{
    key: 'render',
