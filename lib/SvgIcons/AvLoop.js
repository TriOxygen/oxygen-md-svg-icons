...
var AvLoop = function (_Component) {
  _inherits(AvLoop, _Component);

  function AvLoop() {
    _classCallCheck(this, AvLoop);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvLoop).apply(this, arguments));
  }
