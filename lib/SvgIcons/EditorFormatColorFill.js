...
var EditorFormatColorFill = function (_Component) {
  _inherits(EditorFormatColorFill, _Component);

  function EditorFormatColorFill() {
    _classCallCheck(this, EditorFormatColorFill);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorFormatColorFill).apply(this, arguments));
  }

  _createClass(EditorFormatColorFill, [{
    key: 'render',
