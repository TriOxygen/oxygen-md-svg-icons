...
var CommunicationPhone = function (_Component) {
  _inherits(CommunicationPhone, _Component);

  function CommunicationPhone() {
    _classCallCheck(this, CommunicationPhone);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationPhone).apply(this, arguments));
  }

  _createClass(CommunicationPhone, [{
    key: 'render',
