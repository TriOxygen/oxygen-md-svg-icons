...
var ActionStars = function (_Component) {
  _inherits(ActionStars, _Component);

  function ActionStars() {
    _classCallCheck(this, ActionStars);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionStars).apply(this, arguments));
  }

  _createClass(ActionStars, [{
    key: 'render',
