...
var MapsMap = function (_Component) {
  _inherits(MapsMap, _Component);

  function MapsMap() {
    _classCallCheck(this, MapsMap);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsMap).apply(this, arguments));
  }

  _createClass(MapsMap, [{
    key: 'render',
