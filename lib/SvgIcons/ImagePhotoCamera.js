...
var ImagePhotoCamera = function (_Component) {
  _inherits(ImagePhotoCamera, _Component);

  function ImagePhotoCamera() {
    _classCallCheck(this, ImagePhotoCamera);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImagePhotoCamera).apply(this, arguments));
  }

  _createClass(ImagePhotoCamera, [{
    key: 'render',
