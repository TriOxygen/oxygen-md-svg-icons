...
var ActionFavorite = function (_Component) {
  _inherits(ActionFavorite, _Component);

  function ActionFavorite() {
    _classCallCheck(this, ActionFavorite);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionFavorite).apply(this, arguments));
  }

  _createClass(ActionFavorite, [{
    key: 'render',
