...
var ImageTimelapse = function (_Component) {
  _inherits(ImageTimelapse, _Component);

  function ImageTimelapse() {
    _classCallCheck(this, ImageTimelapse);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageTimelapse).apply(this, arguments));
  }

  _createClass(ImageTimelapse, [{
    key: 'render',
