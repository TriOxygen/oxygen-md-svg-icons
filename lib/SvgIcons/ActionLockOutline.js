...
var ActionLockOutline = function (_Component) {
  _inherits(ActionLockOutline, _Component);

  function ActionLockOutline() {
    _classCallCheck(this, ActionLockOutline);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionLockOutline).apply(this, arguments));
  }

  _createClass(ActionLockOutline, [{
    key: 'render',
