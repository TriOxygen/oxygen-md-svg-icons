...
var NotificationSync = function (_Component) {
  _inherits(NotificationSync, _Component);

  function NotificationSync() {
    _classCallCheck(this, NotificationSync);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NotificationSync).apply(this, arguments));
  }

  _createClass(NotificationSync, [{
    key: 'render',
