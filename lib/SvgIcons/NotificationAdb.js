...
var NotificationAdb = function (_Component) {
  _inherits(NotificationAdb, _Component);

  function NotificationAdb() {
    _classCallCheck(this, NotificationAdb);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NotificationAdb).apply(this, arguments));
  }

  _createClass(NotificationAdb, [{
    key: 'render',
