...
var ActionZoomOut = function (_Component) {
  _inherits(ActionZoomOut, _Component);

  function ActionZoomOut() {
    _classCallCheck(this, ActionZoomOut);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionZoomOut).apply(this, arguments));
  }

  _createClass(ActionZoomOut, [{
    key: 'render',
