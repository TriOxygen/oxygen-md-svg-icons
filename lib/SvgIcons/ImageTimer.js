...
var ImageTimer = function (_Component) {
  _inherits(ImageTimer, _Component);

  function ImageTimer() {
    _classCallCheck(this, ImageTimer);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageTimer).apply(this, arguments));
  }
