...
var ActionCached = function (_Component) {
  _inherits(ActionCached, _Component);

  function ActionCached() {
    _classCallCheck(this, ActionCached);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionCached).apply(this, arguments));
  }

  _createClass(ActionCached, [{
    key: 'render',
