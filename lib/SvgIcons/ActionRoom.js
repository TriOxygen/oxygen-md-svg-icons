...
var ActionRoom = function (_Component) {
  _inherits(ActionRoom, _Component);

  function ActionRoom() {
    _classCallCheck(this, ActionRoom);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionRoom).apply(this, arguments));
  }

  _createClass(ActionRoom, [{
    key: 'render',
