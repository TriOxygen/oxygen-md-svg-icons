...
var HardwareMemory = function (_Component) {
  _inherits(HardwareMemory, _Component);

  function HardwareMemory() {
    _classCallCheck(this, HardwareMemory);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(HardwareMemory).apply(this, arguments));
  }

  _createClass(HardwareMemory, [{
    key: 'render',
