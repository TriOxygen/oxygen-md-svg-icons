...
var CommunicationCall = function (_Component) {
  _inherits(CommunicationCall, _Component);

  function CommunicationCall() {
    _classCallCheck(this, CommunicationCall);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationCall).apply(this, arguments));
  }

  _createClass(CommunicationCall, [{
    key: 'render',
