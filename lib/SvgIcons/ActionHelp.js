...
var ActionHelp = function (_Component) {
  _inherits(ActionHelp, _Component);

  function ActionHelp() {
    _classCallCheck(this, ActionHelp);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionHelp).apply(this, arguments));
  }

  _createClass(ActionHelp, [{
    key: 'render',
