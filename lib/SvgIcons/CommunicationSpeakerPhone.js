...
var CommunicationSpeakerPhone = function (_Component) {
  _inherits(CommunicationSpeakerPhone, _Component);

  function CommunicationSpeakerPhone() {
    _classCallCheck(this, CommunicationSpeakerPhone);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunicationSpeakerPhone).apply(this, arguments));
  }

  _createClass(CommunicationSpeakerPhone, [{
    key: 'render',
  ...
  return CommunicationSpeakerPhone;
}(_react.Component);
