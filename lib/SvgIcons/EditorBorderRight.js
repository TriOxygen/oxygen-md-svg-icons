...
var EditorBorderRight = function (_Component) {
  _inherits(EditorBorderRight, _Component);

  function EditorBorderRight() {
    _classCallCheck(this, EditorBorderRight);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorBorderRight).apply(this, arguments));
  }

  _createClass(EditorBorderRight, [{
    key: 'render',
