...
var ImageNaturePeople = function (_Component) {
  _inherits(ImageNaturePeople, _Component);

  function ImageNaturePeople() {
    _classCallCheck(this, ImageNaturePeople);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageNaturePeople).apply(this, arguments));
  }

  _createClass(ImageNaturePeople, [{
    key: 'render',
