...
var ActionHttps = function (_Component) {
  _inherits(ActionHttps, _Component);

  function ActionHttps() {
    _classCallCheck(this, ActionHttps);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionHttps).apply(this, arguments));
  }

  _createClass(ActionHttps, [{
    key: 'render',
