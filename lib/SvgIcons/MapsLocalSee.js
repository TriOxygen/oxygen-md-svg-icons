...
var MapsLocalSee = function (_Component) {
  _inherits(MapsLocalSee, _Component);

  function MapsLocalSee() {
    _classCallCheck(this, MapsLocalSee);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsLocalSee).apply(this, arguments));
  }

  _createClass(MapsLocalSee, [{
    key: 'render',
