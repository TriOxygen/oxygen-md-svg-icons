...
var MapsDirectionsRun = function (_Component) {
  _inherits(MapsDirectionsRun, _Component);

  function MapsDirectionsRun() {
    _classCallCheck(this, MapsDirectionsRun);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapsDirectionsRun).apply(this, arguments));
  }

  _createClass(MapsDirectionsRun, [{
    key: 'render',
