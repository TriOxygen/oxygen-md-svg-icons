...
var ActionVisibility = function (_Component) {
  _inherits(ActionVisibility, _Component);

  function ActionVisibility() {
    _classCallCheck(this, ActionVisibility);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionVisibility).apply(this, arguments));
  }

  _createClass(ActionVisibility, [{
    key: 'render',
