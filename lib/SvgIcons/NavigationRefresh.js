...
var NavigationRefresh = function (_Component) {
  _inherits(NavigationRefresh, _Component);

  function NavigationRefresh() {
    _classCallCheck(this, NavigationRefresh);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavigationRefresh).apply(this, arguments));
  }

  _createClass(NavigationRefresh, [{
    key: 'render',
