...
var ActionPageview = function (_Component) {
  _inherits(ActionPageview, _Component);

  function ActionPageview() {
    _classCallCheck(this, ActionPageview);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionPageview).apply(this, arguments));
  }

  _createClass(ActionPageview, [{
    key: 'render',
