...
var ActionAlarm = function (_Component) {
  _inherits(ActionAlarm, _Component);

  function ActionAlarm() {
    _classCallCheck(this, ActionAlarm);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionAlarm).apply(this, arguments));
  }

  _createClass(ActionAlarm, [{
    key: 'render',
