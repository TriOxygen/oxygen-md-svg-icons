...
var AvNotInterested = function (_Component) {
  _inherits(AvNotInterested, _Component);

  function AvNotInterested() {
    _classCallCheck(this, AvNotInterested);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(AvNotInterested).apply(this, arguments));
  }

  _createClass(AvNotInterested, [{
    key: 'render',
