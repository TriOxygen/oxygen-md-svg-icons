...
var ActionBuild = function (_Component) {
  _inherits(ActionBuild, _Component);

  function ActionBuild() {
    _classCallCheck(this, ActionBuild);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionBuild).apply(this, arguments));
  }

  _createClass(ActionBuild, [{
    key: 'render',
